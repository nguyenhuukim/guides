...
2.  **Project Structure**:
    - **Package by Feature**: Organize directory structure by feature (Feature-based), NOT by layer (Controller/Service/Repository) to ensure high encapsulation and modularity.
