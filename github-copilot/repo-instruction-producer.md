...
- luôn tuân thủ file detailed design
- luôn phản hồi bằng tiếng việt

Tạo các custom instruction cần thiết cho Java Spring boot, Restful API design rule dựa trên skill role tôi đã cung cấp ở trên.
